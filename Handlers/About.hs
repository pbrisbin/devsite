        ...
        addHamlet [hamlet|
            ...
            <article .fullpage>
                ...
                <p>
                    ...
                    hand-holding, and the user is expected to install, 
                    maintain, and configure his entire system on his 
                    own.  Through appropriate use of the amazing Arch 
                    wiki, forums, and IRC, this isn't so bad - it simply 
                    takes reading, and time. The benefit being not only 
                    can you make it exactly what you want, but you'll 
                    learn more than you could imagine about the inner 
                    workings of your system. This transparency and 
                ...
                <p>
                    ...
                    research (manpage, wiki, forum, google, and IRC) 
                    before asking questions - Though most Archers are 
                    extremely friendly, showing that you've done some 
                    research before asking the same often repeated 
                    questions will go a long way in earning the respect 
                    of the group; and, at least in the beginning, I'll 
