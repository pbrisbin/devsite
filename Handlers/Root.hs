...
getRootR = do
    ...
    defaultLayout $ do
        ...
        -- hide breadcrumbs on the index page
        addCassius [$cassius| 
            #breadcrumbs
                display: none
            |]
        ...
        addHamlet [$hamlet|
            ...
            %p
                ...
                \ is a type of tiling window manager. It makes me happy. 
                If you've never used a tiling window manager, the idea
                is simple: automatically resize any open windows to fill 
                the whole monitor with no gaps and no overlap. Usually 
                you get a bunch of virtual workspaces to spread out your 
                windows by category too. And there's always a floating 
                layer available if you want to pop any windows out of 
                the tile and move/resize them freely (or have them start 
                that way by default). It's a very efficient way to work 
                with your computer as you waste no screen space, you can 
                quickly navigate to or rearrange your windows, and you 
